        ...
        >
            {({ isSubmitting }) => (
                <Form>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 40, justifyContent: "space-evenly" }}>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 40,marginTop:20, justifyContent: "flexStart" }}>
                        <div style={{ display: "flex", flexDirection: "column", width: 200 }}>

...
const CTable = (props) => {
  ...
  return (
    <>
    <div className="mx-4 mt-4 rounded-lg overflow-x-auto">
              ...
              <tr className="border-b">
                <td colSpan="7" className="p-2">
                  <div className="flex space-x-4">
                    ...
                    {showInputBox({ id: eachDoc.id ,keyNum : 8, label: "Credit_C", val: eachDoc.credit_card_amount, field: "credit_card_amount", chkFlag: eachDoc.checked })}

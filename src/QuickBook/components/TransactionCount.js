        ...
        <>
            {
                <div className="flex flex-col lg:ml-32 xl:ml-0">
                    <label className="text-blue-600 text-lg font-medium tracking-wide mb-1">Cash Amount</label>
                    <p className="text-2xl">{amountFormatter(totalPaymentCount.Cash_Amount)}</p>
                </div>
            }
            {
                <div className="flex flex-col lg:ml-32 xl:ml-0">
                    <label className="text-blue-600 text-lg font-medium tracking-wide mb-1">Upi Amount</label>
                    <h4 className="text-2xl">{amountFormatter(totalPaymentCount.UPI_Amount)}</h4>
                </div>
            }
            {
                <div className="flex flex-col lg:ml-32 xl:ml-0">
                    <label className="text-blue-600 text-lg font-medium tracking-wide mb-1">Bank Amount</label>
                    <p className="text-2xl">{amountFormatter(totalPaymentCount.Online_Bank_Amount)}</p>
                </div>
            }
            {
                <div className="flex flex-col lg:ml-32 xl:ml-0">
                    <label className="text-blue-600 text-lg font-medium tracking-wide mb-1">Cheque Amount</label>

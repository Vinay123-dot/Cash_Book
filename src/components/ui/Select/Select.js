...
const Select = React.forwardRef((props, ref) => {
    ...
    const handleMenuOpen = () => setIsSearching((prevState) => !prevState);
    const handleMenuClose = () => setIsSearching(false);
    ...
    return (
        <Component
            ...
            components={{
                ...
                DropdownIndicator: isSearching ? DefaultClearIndicator : DefaultDropdownIndicator,
